...
bind_layers(CtrlPDU, LL_PAUSE_ENC_REQ, optcode=0x0A) # BTLE_DATA / CtrlPDU / LL_PAUSE_ENC_REQ
bind_layers(CtrlPDU, LL_PAUSE_ENC_RSP, optcode=0x0B) # BTLE_DATA / CtrlPDU / LL_PAUSE_ENC_RSP
