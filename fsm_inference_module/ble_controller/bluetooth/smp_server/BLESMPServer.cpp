...
static PyObject *configure_connection(PyObject *self, PyObject *args)
{
    ...
    uint16_t handle = 0;
    init_conn(blehost, handle, slave_addr_buffer, slave_address_type);
    //handle++;
...
static PyObject *send_public_key(PyObject *self, PyObject *args)
{

    PySys_WriteStdout("In send_public_key BLESMPServer.cpp \n ");
    bthost_request_public_key(blehost, 0);
...
static PyObject *send_sign_info(PyObject *self, PyObject *args)
{

    PySys_WriteStdout("In send_sign_info BLESMPServer.cpp \n ");
    bthost_request_sign_info(blehost, 0);
...
static PyObject *send_dh_check(PyObject *self, PyObject *args)
{

    PySys_WriteStdout("In send_dh_check BLESMPServer.cpp \n ");
    bthost_request_dh_check(blehost, 0);
...
static PyObject *send_sm_random(PyObject *self, PyObject *args)
{

    PySys_WriteStdout("In send_sm_random BLESMPServer.cpp \n ");
    bthost_request_sm_random(blehost, 0);
...
static PyObject *send_pair_confirm(PyObject *self, PyObject *args)
{

    PySys_WriteStdout("In send_pair_confirm BLESMPServer.cpp \n ");
    bthost_request_pair_confirm(blehost, 0);
